...
<body class="page team-page">
    ...
    <main class="page-team-main">
        ...
        <section class="page-banner-container inner-page-banner"
            ...
            <div class="container container-xl">
                <div class="action-wrapper">
                    <a href="#" class="btn-youtube videoModalToggler"
                        data-theVideo="https://www.youtube.com/embed/uVRDEiZygvE?rel=0" data-toggle="modal"
                        data-target="#videoModal">
                        <svg id="play-button-icon" xmlns="http://www.w3.org/2000/svg" width="84.1" height="59.3"
                            viewBox="0 0 84.1 59.3">
                            <path id="Path_348" data-name="Path 348"
                                ...
                                fill="#ff5c00" />
                            <path id="Path_349" data-name="Path 349" d="M33.3,41.4V17.8L56,29.6" fill="#fff" /> </svg>
                    </a>
                </div>
                <div class="banner-outer-wrapper">

                    <div class="text-wrapper">
                        <h1 class="bottom-left">L'Agence</h1>
                    </div>
        ...
        <div class="banner-bottom-decoration">
            <span class="decoration-before">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 790 150"
                    style="enable-background:new 0 0 790 150;" width="790px" height="151px" xml:space="preserve">
                    <g>
                ...
                <div class="container container-md">
                    ...
                    <div class="team-contact-wrapper">
                        ...
                        <div class="contact-block">
                            ...
                            <a href="tel:+32 2 385 02 65" class="contact-number">+32 2 385 02 65</a>
                        </div>
                        ...
                        <div class="contact-block">
                            ...
                            <a href="tel:+32 67 70 07 79" class="contact-number">+32 67 70 07 79</a>
                        </div>
            ...
            <span class="decoration-after"></span>
        </div>

        <section class="team-members">
            <div class="container container-md">
                <div class="member-blocks-wrapper">
                    <h3>L’équipe Cedimmo</h3>
                    ...
                    <p class="team-footer-text mt-120 mb-120">
                        Nous sommes toujours à la recherche de nouveaux talents! <a href="#" class="cta-link"
                            data-toggle="modal" data-target="#contactForm">Contactez-nous</a>
                    </p>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" allowfullscreen="1"
                            ...
                            src="https://www.youtube.com/embed/uVRDEiZygvE?rel=0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade video-modal" id="agencyVideoModal" tabindex="-1" role="dialog"
            aria-labelledby="agencyVideoModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" allowfullscreen="1"
