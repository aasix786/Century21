...
<head>
    ...
    <!-- Title -->
    <title>Services Immobilier - Cedimmo</title>
    ...
    <title>Services Immobilier - Cedimmo</title>
    <meta property="og:title" content="Services Immobilier - Cedimmo" />
    <meta property="og:description"
        content="Découvrez tous les services de Cedimmo : L'agence immobilière propose des services exclusifs pour mettre en valeur votre bien et le valoriser au maximum dans le cadre de sa vente ou sa location. Photos de qualité, retouche photo,  visites virtuelles, vidéos et photos aériennes par drone sont autant de moyens pour optimiser la visibilité de votre bien." />
    <meta name="title" content="Services Immobilier - Cedimmo" />
    <meta name="description"
        content="Découvrez tous les services de Cedimmo : L'agence immobilière propose des services exclusifs pour mettre en valeur votre bien et le valoriser au maximum dans le cadre de sa vente ou sa location. Photos de qualité, retouche photo,  visites virtuelles, vidéos et photos aériennes par drone sont autant de moyens pour optimiser la visibilité de votre bien." />
    <meta name="keywords"
        content="vision, cedimmo,agence immobili&#232;re braine-l&#39;alleud,agence immobili&#232;re braine-le-ch&#226;teau" />
...
<body class="services-page page">
        ...
        <div class="navbar-container">
            <div class="container container-xl">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-inner-wrapper active headerNavBar">
                        ...
                        <ul class="nav-links">
                            ...
                            <li class="active"><a href="estimation.blade.php" class="link-item">Services</a></li>
                        </ul>

                        <ul class="nav-links">
                            <li class=""><a href="agence-cedimmo.blade.php" class="link-item">L'agence</a></li>
    ...
    <main class="page-services-main">
        ...
        <section class="page-banner-container"
            style="background-image: url('assets/front/app/assets/images/services-banner.jpg')">
            ...
            <div class="container container-xl">
                ...
                <div class="banner-outer-wrapper">
                    ...
                    <div class="banner-wrapper">
                        ...
                        <div class="image-wrapper order-lg-2">
                            <div class="embed-responsive embed-responsive-16by9 banner-video bannerVideo">
                                <video class="embed-responsive-item" id="videoTag" type="video/mp4" controls="true"
                                    width="100%" height="100%" frameborder="0" allowfullscreen="" muted="" loop="">
                                    <source src="{{asset('user/services_cedimmo_new_v2.mp4')}}" type="video/mp4">
                                    Your browser does not support HTML5 video.
                                </video>
                            </div>
                        </div>
                        <div class="text-wrapper order-lg-1">
                            <h1>Nos Services</h1>
                            <p class="sub-title">Ce que Cedimmo fait pour vous</p>
                            <div class="image-mobile-wrapper">
                                <div
                                    class="embed-responsive embed-responsive-16by9 banner-video banner-mobile-video bannerMobileVideo">
                                    <video class="embed-responsive-item" id="mobileVideoTag" type="video/mp4"
                                        controls="true" width="100%" height="100%" frameborder="0" allowfullscreen=""
                                        muted="" loop="" preload="yes"
                                        poster="{{asset('user/assets/front/app/assets/images/services-video-banner.jpg')}}">
                                        <source src="{{asset('user/services_cedimmo_new_v2.mp4')}}" type="video/mp4">
                                        Your browser does not support HTML5 video.
                                    </video>
                                </div>
                            </div>
                            <a href="#serviceContainer" class="info smoothScroll">
                                <svg xmlns="http://www.w3.org/2000/svg" width="12.778" height="16.863"
                                    viewBox="0 0 12.778 16.863" class=" rotate-180">
                                    <g id="long-arrow-icon" transform="translate(0.707 0.707)">
                                        <line id="Line_167" data-name="Line 167" y1="15"
                                            transform="translate(5.707 0.657)" fill="none" stroke="#ff5c00"
                                            stroke-linecap="round" stroke-width="1" />
                                        <line id="Line_168" data-name="Line 168" y1="8"
                                            transform="translate(5.707 0) rotate(-45)" fill="none" stroke="#ff5c00"
                                            stroke-linecap="round" stroke-width="1" />
                                        <line id="Line_169" data-name="Line 169" y2="8"
                                            transform="translate(0 5.657) rotate(-135)" fill="none" stroke="#ff5c00"
                                            stroke-linecap="round" stroke-width="1" />
                                    </g>
                                </svg>
                                Découvrez
                    ...
                    <div class="banner-bottom-text">
                        ...
                        <a href="#" class="btn btn-outlined-danger" data-toggle="modal"
                            data-target="#propertyForm">EstimeR MON bien</a>
                    </div>
                </div>
            </div>
            <!-- <div class="bottom-decoration">
                <div class="banner-bottom-decoration">
                    <span class="decoration-left"></span>

                    <span class="decoration-right"></span>
                </div>
                <div class="curve-decoration" style="background-image: url('https://cedimmo.be/assets/front/app/assets/images/decorative-element.svg');"></div>
            </div> -->
            <section class="review-container">
                <div class="bottom-decoration">
                    <div class="banner-bottom-decoration">
                        <span class="decoration-left"></span>
                        <span class="decoration-center">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 790 150"
                                style="enable-background:new 0 0 790 150;" width="790px" height="151px"
                                xml:space="preserve">
                                <g>
                                    <path style="fill:#f9fafc;"
                                        d="M0,0.5V150h790V0.5c-226,0.1-225.9,149-395,149C227,149.5,227,0.5,0,0.5z" />
                                </g>
                            </svg>
                        </span>
                        <span class="decoration-right"></span>
                ...
                <div class="container container-xl">
                    <div class="review-wrapper">
                        ...
                        <div class="review-block inverse">
                            <div class="review-logo">
                                <a href="https://fr-fr.facebook.com/pg/Cedimmo/reviews/?ref=page_internal"
                                    target="_blank">
        ...
        <section class="service-container" id="serviceContainer">

            <div class="gray-wrapper with-paddingb">
                <div class="container container-xl">
                    ...
                    <div class="inner-content-wrapper">
                        <div class="row item-center">
                            <div class="cs-col col-md-6">
                                <div class="inner-content-block">
                                    <div class="yt-wrapper">
                                        <a href="#" class="play videoModalToggler" data-toggle="modal"
                                            data-target="#videoModal"
                                            data-theVideo="https://www.youtube.com/embed/qej1D2HQLZY?rel=0">
                                        ...
                                        <img src="assets/front/app/assets/images/service-video-placehoder.jpg" alt=""
                            ...
                            <div class="cs-col col-md-6">
                                <div class="inner-content-block">
                                    <div class="text-wrapper right-block">
                                        <h2>Vidéo</h2>
                                        <p class="sub-title">Vous voulez rendre votre bien unique?</p>
                                        <p class="content">La vidéo saura dynamiser au maximum tous les atouts de votre
                                            bien. Elle est un moyen unique de se faire une bonne opinion de l'ensemble
                                            de la propriété et de son environnement immédiat.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="white-wrapper fluid-media-wrapper reverse mb-80">
                <div class="inner-content-wrapper">
                    <div class="container container-xl">
                        <div class="row item-center">
                            <div class="cs-col col-lg-6 order-lg-2">
                                <div class="inner-media-block bl-radius">
                                    <div class="twentytwenty-container" data-twentytwenty data-offset="0.25">
                                        <img src="assets/front/app/assets/images/properties/services-01.jpg"
                                            class="img-responsive" />
                                        <img src="assets/front/app/assets/images/properties/services-02.jpg"
                                            class="img-responsive" />
                                    </div>
                                </div>
                            </div>
                            <div class="cs-col col-lg-6 order-lg-1">
                                <div class="inner-content-block">
                                    <div class="text-wrapper left-block">
                                        <h2>Photos de qualité</h2>
                                        <p class="sub-title">Vous pouvez avoir une même pièce mais un rendu différent
                                            entre une photo amateur et une photo professionnelle.</p>
                                        <p class="content">La différence s’explique par de nombreuses formations, une
                                            technologie HDR, des conseils précieux avant la prise de photo et un
                                            matériel de qualité.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="white-wrapper fluid-media-wrapper">
                <div class="inner-content-wrapper">
                    <div class="container container-xl">
                        <div class="row item-center">
                            <div class="cs-col col-lg-6">
                                <div class="inner-media-block tr-radius">
                                    <div class="twentytwenty-container" data-twentytwenty data-offset="0.7">
                                        <img src="assets/front/app/assets/images/properties/services-03.jpg"
                                            class="img-responsive" />
                                        <img src="assets/front/app/assets/images/properties/services-04.jpg"
                                            class="img-responsive" />
                                    </div>
                                </div>
                            </div>
                            <div class="cs-col col-lg-6">
                                <div class="inner-content-block">
                                    <div class="text-wrapper right-block">
                                        ...
                                        <p class="sub-title">Cette technique est devenue incontournable afin d’obtenir
                                            au visuel un rendu de qualité.</p>
                                        <p class="content">Nous avons tendance à accumuler des objets qui provoquent une
                                            réaction négative chez le visiteur sans le savoir. La technologie nous
                                            permet de nettoyer une pièce afin de la rendre plus attrayante et épurée
                                            pour le regard du visiteur.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="mid-content" style="background-image: url('assets/front/app/assets/images/large-bg.jpg')">
                <div class="container container-xl">
                    <div class="mid-content-wrapper">
                        <h2>Photos Aérienne par drone</h2>
                        <p class="text">Avec l’apport du drone, vous allez donner une autre dimension à votre bien. Le
                            drone permet d’obtenir une vision plus étendue de votre propriété et de la rendre ainsi
                            exclusive.</p>
                    </div>
                </div>
            </section>

            <div class="white-wrapper with-padding">
                <div class="container container-xl">
                    <div class="inner-content-wrapper">
                        <div class="row item-center">
                            <div class="cs-col col-md-6 order-md-2">
                                <div class="inner-content-block">
                                    <div class="yt-wrapper">
                                        <a href="#" class="play videoModalToggler" data-toggle="modal"
                                            data-target="#threeDVideoModal"
                                            data-theVideo="https://www.youtube.com/embed/ZncJrtUXpr4?rel=0">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="106" height="106"
                                                viewBox="0 0 106 106">
                                                <defs>
                                                    <filter id="Ellipse_73" x="0" y="0" width="106" height="106"
                                                ...
                                                <g id="_3d-visite-play-button-icon"
                                                    data-name="3d-visite-play-button-icon"
                                                    transform="translate(-353 -2311)">
                                                    <g transform="matrix(1, 0, 0, 1, 353, 2311)"
                                                        filter="url(#Ellipse_73)">
                                                        <g id="Ellipse_73-2" data-name="Ellipse 73"
                                                            transform="translate(3 1)" fill="none" stroke="#fff"
                                                            stroke-width="4">
                                                    ...
                                                    <path id="Polygon_6" data-name="Polygon 6" d="M10.5,0,21,18H0Z"
                                                        transform="translate(415.5 2351.5) rotate(90)" fill="#fff" />
                                                </g>
                                            </svg>

                                            <p class="white-mini-primary-text">Explorer la visite 3D</p>

                                        </a>
                                        <img src="assets/front/app/assets/images/services-visite_virtuelle.jpg" alt=""
                                            class="img-responsive">
                                    </div>
                                </div>
                            </div>
                            <div class="cs-col col-md-6 order-md-1">
                                <div class="inner-content-block">
                                    <div class="text-wrapper left-block">
                                        <h2>La visite virtuelle</h2>
                                        <p class="sub-title">Chez Cedimmo grâce à la visite virtuelle les potentiels
                                            acquéreurs se projettent dans votre bien avant même la réelle visite de
                                            celui-ci.</p>
                                        <p class="content">Ils pourront ainsi mieux comprendre les photos et comment se
                                            compose votre bien. Ainsi en visite réelle, ils seront déjà séduits!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="bottom-text-container"
            style="background-image: url('assets/front/app/assets/images/service-juridique.jpg')">
            <div class="container container-xl">
                <div class="bottom-text-wrapper">
                    <div class="text-wrapper">
                        <h2>Juridique</h2>
                        <p class="sub-title">Chez Cedimmo, nous vous offrons un accompagnement et un suivi professionnel
                            complet dans la réalisation de votre projet immobilier. Nous rédigeons les compromis de
                            vente, en étroite collaboration avec les notaires, et organisons la signature au sein de nos
                            agences avec les parties concernées.</p>
                        <p class="content">Nous garantissons la signature du compromis de vente dans les meilleurs
                            délais afin de rendre ce moment important le plus convivial possible tant pour nos
                            propriétaires que nos clients acquéreurs.</p>
                        <p class="content">Dans le cadre de l’acquisition d’un bien nécessitant une intervention auprès
                            des administrations, nous vous accompagnons également lors des rendez-vous pris avec le
                            service Urbanisme de la commune concernée. Nous étudions ensemble les possibilités qui
                            s’ouvrent à vous dans le cadre de vos divers projets d’aménagements (nouvelle construction,
                            modification/transformation d’un bien existant, …) </p>
                        <p class="content">Nous sommes également à votre disposition pour la mise en location de vos
                            biens. Notre mission comprend, en plus de la recherche et accompagnement de candidat
                            locataire, la rédaction du bail, sa signature en agence ainsi que l’enregistrement de
                            celui-ci.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="agency-brand-container">
            <div class="container container-xl">
                <div class="agency-brand-wrapper">
                    <div class="brand-block">
                        <p class="sub-title">CEDIMMO ÉLU 4 ANNÉES CONSÉCUTIVES</p>
                        <h2>Meilleure agence du Brabant wallon</h2>
                    </div>
                    <div class="brand-block brand-image-block">
        ...
        <section class="contact-form-container gray-wrapper with-padding">
            <div class="container container-xl">
                <div class="contact-form">
                    <form action="https://cedimmo.be/saveContact" method="post">

                        <div class="form-header">
                            <div class="header-wrapper">
                                <h4 class="form-title">Contactez-nous ou prenez rendez-vous</h4>
                                <p class="form-sub-title">Remplissez ce formulaire ou <a href="tel:+32 2 385 02 65"
                                        data-fn-toggleslide=".contactToggler"
                                        class="btn btn-outlined-danger btn-text-primary btnContactToggler">Appelez-nous</a>
                                </p>
                                <p class="contactToggler mt-2" style="display:none"><a href="tel:+32 2 385 02 65">BRAINE
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="concerne" name="concerne"
                                            placeholder="Concerne">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea type="name" class="form-control" id="message" name="message"
                                    ...
                                    <div class="col-sm-12">
                                        <label class="item-toggle">
                                            ...
                                            <span class="toggle-text">En cochant la case, je déclare accepter que mes
                                                ...
                                                demande écrite à l’adresse <a
                                                    href="mailto:info@cedimmo.be">info@cedimmo.be</a>. J’ai également
                                                pris connaissance des <a href="ConditionsGenerales.html">conditions
                                                    d’utilisation du site</a> et <a href="Cookies.html">des
                                                    cookies</a> et les accepte</span>
                                        </label>
                                    </div>
    ...
    <div class="popup-container">
        ...
        <div class="modal fade video-modal" id="videoModal" tabindex="-1" role="dialog" aria-labelledby="videoModal"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <a href="#" class="close-btn" data-dismiss="modal" aria-label="Close"><i
                            class="fas fa-times"></i></a>
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" allowfullscreen="1"
                            allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                            title="YouTube video player" class="embed-responsive-item"
                            src="https://www.youtube.com/embed/qej1D2HQLZY?allowfullscreen=1&amp;rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade video-modal" id="threeDVideoModal" tabindex="-1" role="dialog"
            aria-labelledby="threeDVideoModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <a href="#" class="close-btn" data-dismiss="modal" aria-label="Close"><i
                            class="fas fa-times"></i></a>
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" allowfullscreen="1"
                            allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
                            title="YouTube video player" class="embed-responsive-item"
                            src="https://www.youtube.com/embed/ZncJrtUXpr4?allowfullscreen=1&amp;rel=0"
                            allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade banner-video-modal" id="bannerVideoModal" tabindex="-1" role="dialog"
            aria-labelledby="bannerVideoModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <a href="#" class="close-btn" data-dismiss="modal" aria-label="Close"><i
                            class="fas fa-times"></i></a>
                    <div class="embed-responsive embed-responsive-16by9">
                        <video class="embed-responsive-item" id="bannerVideo" width="100%" height="100%" frameborder="0"
    ...
    <script type="text/javascript">
        $("document").ready(function () {
            ...
            // if (wWidth < 992) {
            // 	$('.banner-mobile-video').find("iframe")[0].src += "&autoplay=1";
            // } else {
            // 	$('.banner-video').find("iframe")[0].src += "&autoplay=1";
            // }
        ...
        function autoPlayYouTubeModal() {
            ...
            $('#videoModal, #threeDVideoModal').on('hidden.bs.modal', function (e) {
                console.log('Hello');
    ...
    <script>
        ...
        var mobileVideoTag = document.getElementById("mobileVideoTag");
        var videoItem;
        $(document).ready(function () {
            $('.bannerVideo, .bannerMobileVideo').on('click', function (event) {
                event.preventDefault();
                $('#bannerVideoModal').modal('show');
        ...
        $(window).scroll(function () {
            var oTop = $('.banner-wrapper').offset().top - (window.innerHeight - 200);
            var oBottom = $('.banner-bottom-text').offset().top;
